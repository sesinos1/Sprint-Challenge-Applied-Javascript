...
Events are actions or occurrences that happen in the system you are programming, which the system tells you about so you can respond to them in some way if desired.ect(click)

3. What is an event listener?

 A EventTarget method addEventListener() sets up a function that will be called whenever the specified event is delivered to the target.

4. Why would we convert a NodeList into an Array?

 To use a forEach in your js.
